...
public class DataProvider extends ContentProvider {
	...
	public static final Uri CONTENT_URI_MESSAGES = Uri.parse("content://com.example.instac.provider/messages");
	public static final Uri CONTENT_URI_PROFILE = Uri.parse("content://com.example.instac.provider/profile");
	...
	static {
		...
		uriMatcher.addURI("com.example.instac.provider", "messages", MESSAGES_ALLROWS);
		uriMatcher.addURI("com.example.instac.provider", "messages/#", MESSAGES_SINGLE_ROW);
		uriMatcher.addURI("com.example.instac.provider", "profile", PROFILE_ALLROWS);
		uriMatcher.addURI("com.example.instac.provider", "profile/#", PROFILE_SINGLE_ROW);
	}
